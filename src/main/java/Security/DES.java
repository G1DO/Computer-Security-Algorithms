...
public class DES {
    ...
    private static String binaryToHex(String binary) {
        ...
        // Ensure the hex string is 16 characters (64 bits / 4)
    ...
    private static String[] generateSubKeys(String keyBin) {
        ...
        for(int i = 0; i < 16; ++i) {
            ...
            // Apply PC2 permutation to get subkey
    ...
    private String feistel(String R, String subKey) {
        // Step 1: Expansion - expand R from 32 bits to 48 bits
        String expanded = permute(R, E);

        // Step 2: XOR expanded R with the subkey
        ...
        for(int i = 0; i < 8; ++i) {
            // Extract 6-bit chunk
            String chunk = xored.substring(i * 6, (i + 1) * 6);
